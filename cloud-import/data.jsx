...
const AGENTS = [
  {
    ...
    claims: {
      ...
      pl: [
        ...
        { t: 'Pula bez locka - płynność wyjścia testowana przy 50M+ w jednoblokowych wyplatach w ostatnim kwartale', s: 1 },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    claims: {
      ...
      pl: [
        ...
        { t: 'Wolumen dyskusji CT wokol Aave v3 Base wzrosl 18 procent w/w, głównie framing neutralny', s: 10 },
        { t: 'Brak sygnału w ktoryms kierunku wystarczająco mocnego by przewazyc kwant-driven wynik', s: null },
...
const I18N = {
  ...
  pl: {
    ...
    languageToggle: 'EN',
    title: 'CONCLAVE',
    subtitle: 'Podglad debaty na żywo',
    state: 'Stan',
    ...
    unfocus: 'Pokaż wszystkich',
    waitingTitle: 'Oczekiwanie na propozycję',
