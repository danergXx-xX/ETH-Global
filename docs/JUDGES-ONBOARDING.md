...
| **ETHGlobal Finalist** | Five trust mechanisms wired end-to-end (see below); 5 contracts deployed and verified; 150+ tests pass; original Moat 5 Proof-of-Work for agents | This whole repo |
...
| MockUSDC | [`0x606E...Bb59d`](https://sepolia.basescan.org/address/0x606EDE7755131e6206A29B67d88761eEbb3Bb59d) | 1M mUSDC treasury |
...
- A fifth contract `AdversarialAuditor` (6th agent challenging consensus) is on the roadmap but cut from MVP.
